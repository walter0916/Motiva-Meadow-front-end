        ...
        <ul>
          ...
          <li className='w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/20 transition ease-linear duration-150'>
            <NavLink className='link flex flex-row' to="/">                
              ...
              <div className="flex flex-col">
                <span className="lacktext-lg font-bold leading-5 text-b">Dashboard</span>
          ...
          <li className='w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/20 transition ease-linear duration-150'>
            ...
            <div>
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold leading-5 text-white">Calender</span>
          ...
          <NavLink className='link flex flex-row' to="/">
            <div>
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold leading-5 text-white">Hobbies</span>
                <span className="text-sm text-white/50 hidden md:block">Manage and Track Hobbies</span>
              </div>
            </NavLink>
          </li>
          <li className='w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/20 transition ease-linear duration-150'>
            <NavLink className='link flex flex-row' to="/">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold leading-5 text-white">Goals</span>
          ...
          <li className='w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/20 transition ease-linear duration-150'>
            <NavLink className='link flex flex-row' to="/">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold leading-5 text-white">Tasks</span>
          ...
          <li className='w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/20 transition ease-linear duration-150'>
            <NavLink className='link flex flex-row' to="/">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold leading-5 text-white">Friends</span>
          ...
          <li className='w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/20 transition ease-linear duration-150'>
            <NavLink className='link flex flex-row' to="/">
              ...
              <div className="flex flex-col">
                <span className="text-lg font-bold leading-5 text-white">Settings</span>

...
const SideBar = ({ user, profile , handleLogout }) => {
  ...
  return (
    ...
    {isToggleable && (
      ...
      <nav className={`bg-[#ffffc8]  min-h-screen z-20 text-black laptop:w-1/5 iphone:fixed left-0 h-screen font-poppins overflow-y-auto ${isOpen || !isToggleable ? 'w-full' : 'hidden'}`}>
        {user ?
          <ul>
